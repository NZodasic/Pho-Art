<?php 
    ...
    if(isset($_POST['order'])){
        if(isset($_SESSION['fullname'])){
            ...
            $sql2 = "INSERT INTO dathang (madathang, makh, trangthai, tongtien, ngaydathang, giaohang, id_kh) VALUES ('$madh', '$makh', 'pending', '$tongtien', '$date', 'COD', '0') ";
            ...
            foreach($cart as $keyID => $valueID){
                ...
                VALUES ('$madh', '$makh', '$id_sanpham', '$tensp', '$soluong', '$giatien', '$tongtien', 'pending', '$date', '0', '0') ";
            ...
            echo "<script>alert('You have to login to using this function');</script>";
        }
    }
    ...
    if(isset($_POST['ordervnpay'])){
            ...
            $sql2 = "INSERT INTO dathang (madathang, makh, trangthai, tongtien, ngaydathang, id_kh) VALUES ('$madh', '$makh', 'pending', '$tongtien', '$date', '0') ";
            $query2 = mysqli_query($conn, $sql2);
